...
/// @nodoc
mixin _$SaveCharacterState {
  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is SaveCharacterState);
  }
...
/// @nodoc
class $SaveCharacterStateCopyWith<$Res> {
  $SaveCharacterStateCopyWith(
      SaveCharacterState _, $Res Function(SaveCharacterState) __);
}

/// Adds pattern-matching-related methods to [SaveCharacterState].
extension SaveCharacterStatePatterns on SaveCharacterState {
...
class _Initial implements SaveCharacterState {
  const _Initial();
  ...
  @override
  String toString() {
    return 'SaveCharacterState.initial()';
  }
}

/// @nodoc

class _Saving implements SaveCharacterState {
  const _Saving();
  ...
  @override
  String toString() {
    return 'SaveCharacterState.saving()';
  }
}

/// @nodoc

class _Saved implements SaveCharacterState {
  ...
  @override
  String toString() {
    return 'SaveCharacterState.saved(character: $character)';
  }
}

/// @nodoc
abstract mixin class _$SavedCopyWith<$Res>
    implements $SaveCharacterStateCopyWith<$Res> {
...
class _Error implements SaveCharacterState {
  ...
  @override
  String toString() {
    return 'SaveCharacterState.error(error: $error)';
  }
}
